...
document.addEventListener('DOMContentLoaded', () => {
    ...
    <aside id="app-sidebar" class="w-64 bg-white dark:bg-gray-800 shadow-lg p-4 flex flex-col h-full flex-shrink-0 transition-transform -translate-x-full lg:translate-x-0 z-40">
        ...
        <nav class="flex-grow space-y-2" id="main-nav">
            ...
            <a href="../assessment.html" class="flex items-center px-4 py-2 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700"><i class="fas fa-brain w-6 text-center"></i><span class="ml-3" data-translate-key="nav_quiz">Assessment</span></a>
