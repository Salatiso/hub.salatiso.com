            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white p-6 rounded-xl shadow-md">
                    ...
                    <div class="flex flex-col space-y-3">
                        ...
                        <button onclick="navigateTo('leave')" class="w-full text-left p-3 bg-amber-50 hover:bg-amber-100 rounded-lg transition-colors"><i class="fas fa-calendar-check mr-3 text-amber-600"></i>Review Leave</button>
                        <button onclick="navigateTo('payroll')" class="w-full text-left p-3 bg-green-50 hover:bg-green-100 rounded-lg transition-colors"><i class="fas fa-money-check-dollar mr-3 text-green-600"></i>Run Payroll</button>
                    </div>
                </div>
            </div>
        </div>
