...
// Initialize the LegalHelp when Firebase is ready
document.addEventListener('firebase-ready', () => {
    console.log('Firebase ready event received, initializing LegalHelp...');
    onAuthStateChanged(auth, (user) => {
        if (user) {
            console.log('User authenticated, initializing LegalHelp for:', user.email);
            init(user);
        } else {
